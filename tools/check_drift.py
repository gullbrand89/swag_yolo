...
from transformer_post_generator.data import make_pairs
from transformer_post_generator.vocab import ids_to_tokens  # noqa: F401  (håller importvägen densamma som träningen)
